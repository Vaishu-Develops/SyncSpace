...
const SettingsPage = () => {
    ...
    const [settings, setSettings] = useState({
        ...
        taskReminders: true,
        weeklyDigest: true,
        // darkMode is now handled by ThemeContext
        language: 'en',
        timezone: 'UTC',
        twoFactorAuth: false
    });
    ...
    const ToggleSetting = ({ label, description, value, onChange }) => (
        <div className="flex items-center justify-between py-3">
            <div className="flex-1">
                ...
                {description && <p className="text-xs text-slate-500 dark:text-gray-400 mt-1">{description}</p>}
            </div>
            <button
                onClick={onChange}
        ...
        <div className="flex flex-col h-full bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white transition-colors duration-300">
            ...
            <main className="flex-1 p-4 md:p-8 overflow-y-auto">
                <div className="max-w-4xl mx-auto">
                    ...
                    {/* Danger Zone */}
                    <div className="card border-danger/50 dark:border-danger/50">
