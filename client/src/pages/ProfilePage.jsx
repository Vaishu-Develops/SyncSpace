            ...
            <div className="flex-1 flex flex-col">
                ...
                <main className="flex-1 p-4 md:p-8 overflow-y-auto">
                    <div className="max-w-4xl mx-auto">
                        <div className="card">
                            {/* Profile Header */}
                            <div className="flex flex-col md:flex-row items-start md:items-center gap-6 pb-6 border-b border-slate-700">
                                <div className="relative group">
                                    <div className="h-24 w-24 rounded-full overflow-hidden border-4 border-slate-700 bg-slate-800 flex items-center justify-center">
                            ...
                            <form onSubmit={handleSubmit} className="mt-6 space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                disabled={!isEditing}
                                                className="w-full bg-slate-800 border border-slate-700 rounded-lg pl-10 pr-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary disabled:opacity-50 disabled:cursor-not-allowed"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        disabled={!isEditing}
                                        rows={4}
                                        className="w-full bg-slate-800 border border-slate-700 rounded-lg px-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary disabled:opacity-50 disabled:cursor-not-allowed resize-none"
                            ...
                            <div className="mt-8 pt-6 border-t border-slate-700">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div className="bg-slate-800/50 rounded-lg p-4">
                                        ...
                                        <p className="text-lg font-semibold text-white">{stats.workspaces}</p>
                                    </div>
                                    <div className="bg-slate-800/50 rounded-lg p-4">
