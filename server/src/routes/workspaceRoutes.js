...
const { createWorkspace, getWorkspaces, getWorkspaceById, updateWorkspace, deleteWorkspace, getWorkspaceMembers, togglePinWorkspace } = require('../controllers/workspaceController');
...
router.route('/:id/pin').put(protect, togglePinWorkspace);
